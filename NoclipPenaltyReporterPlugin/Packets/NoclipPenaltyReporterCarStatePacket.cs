...
/// 4. Server processes packet and applies no-clip if needed
/// </summary>

using AssettoServer.Network.ClientMessages;

namespace NoclipPenaltyReporterPlugin.Packets;
...
public class NoclipPenaltyReporterCarStatePacket : OnlineEvent<NoclipPenaltyReporterCarStatePacket>
{
    ...
    /// Server uses this to decide whether to disable collisions
    /// </summary>
